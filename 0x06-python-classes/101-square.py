...
class Square:
    ...
    def __str__(self):
        ...
        for _ in range(self.size):
            """Add horizontal spacing based on the horizontal position"""
            square_repr += " " * self.position[0]

            """Add the '#' character for each column of the square"""
            square_repr += "#" * self.size
